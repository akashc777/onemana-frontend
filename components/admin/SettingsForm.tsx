...
const GROUPS: { group: string; fields: FieldDef[] }[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "cloud_margin_floor", label: "Margin floor (%)", type: "number", hint: "Default 50. A machine leaving less than this share of a plan's revenue is never bought; the customer waits and you are told. Revenue is before GST (the whole price when foreign sales are zero-rated exports), less Razorpay's 3% and ₹150 overhead; the machine is priced before GST, which is claimed back. The Workspaces tab shows each size's margin." },
