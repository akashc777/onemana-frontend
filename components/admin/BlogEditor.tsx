        ...
        <div className="space-y-4">
          ...
          <Field label="Cover image">
            <div className="space-y-2">
              {coverImage && <p className="truncate text-xs text-muted-foreground">{coverImage}</p>}
              <div className="flex gap-2">
                ...
                <button
                  ...
                  disabled={uploading}
                  className="shrink-0 rounded-lg border border-border bg-muted px-3 text-sm text-foreground/80 hover:bg-muted"
                >
                  Upload
                </button>
              </div>
